    ...
    <basic-container>
      ...
      <div v-loading="loading">
        ...
        <template v-if="activeIndex === '7'">
          ...
          >
            <el-descriptions
              :title="$t('deviceManage.batteryInfo')"
              :column="3"
            >
              <el-descriptions-item
          ...
          >
            ...
            >
              ...
              >
                {{
                  USBFilter[
                    operationInformation.otherInformationObj.usbStatusVal
                  ]
                }}
              </el-descriptions-item>
              <el-descriptions-item
