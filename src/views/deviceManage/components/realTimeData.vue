      ...
      <template v-if="activeIndex === '7'">
        ...
        <el-card style="margin-top: 10px;" v-if="operationInformation.otherInformation">
          <el-descriptions :title="$t('deviceManage.otherInformation')" :column="2">
            ...
            <el-descriptions-item :label="$t('deviceManage.protocolAddress144')" v-if="operationInformation.otherInformationObj.protocolAddress144">
              {{ operationInformation.otherInformationObj.protocolAddress144Val }}
            </el-descriptions-item>
            <el-descriptions-item :label="$t('deviceManage.protocolAddress146')" v-if="operationInformation.otherInformationObj.protocolAddress146">
              {{ operationInformation.otherInformationObj.protocolAddress146Val }}
            </el-descriptions-item>
            <el-descriptions-item :label="$t('deviceManage.protocolAddress148')" v-if="operationInformation.otherInformationObj.protocolAddress148">
              {{ operationInformation.otherInformationObj.protocolAddress148Val }}
            </el-descriptions-item>
            <el-descriptions-item :label="$t('deviceManage.protocolAddress150')" v-if="operationInformation.otherInformationObj.protocolAddress150">
              {{ operationInformation.otherInformationObj.protocolAddress150Val }}
            </el-descriptions-item>
            <el-descriptions-item :label="$t('deviceManage.protocolAddress152')" v-if="operationInformation.otherInformationObj.protocolAddress152">
              {{ operationInformation.otherInformationObj.protocolAddress152Val }}
            </el-descriptions-item>
            <el-descriptions-item :label="$t('deviceManage.protocolAddress153')" v-if="operationInformation.otherInformationObj.protocolAddress153">
              {{ operationInformation.otherInformationObj.protocolAddress153Val }}
            </el-descriptions-item>
            <el-descriptions-item :label="$t('deviceManage.protocolAddress154')" v-if="operationInformation.otherInformationObj.protocolAddress154">
              {{ operationInformation.otherInformationObj.protocolAddress154Val }}
            </el-descriptions-item>
            <el-descriptions-item :label="$t('deviceManage.protocolAddress155')" v-if="operationInformation.otherInformationObj.protocolAddress155">
              {{ operationInformation.otherInformationObj.protocolAddress155Val }}
            </el-descriptions-item>
            <el-descriptions-item :label="$t('deviceManage.protocolAddress156')" v-if="operationInformation.otherInformationObj.protocolAddress156">
              {{ operationInformation.otherInformationObj.protocolAddress156Val }}
            </el-descriptions-item>
            <el-descriptions-item :label="$t('deviceManage.protocolAddress157')" v-if="operationInformation.otherInformationObj.protocolAddress157">
              {{ operationInformation.otherInformationObj.protocolAddress157Val }}
            </el-descriptions-item>
            <el-descriptions-item :label="$t('deviceManage.protocolAddress158')" v-if="operationInformation.otherInformationObj.protocolAddress158">
              {{ operationInformation.otherInformationObj.protocolAddress158Val }}
            </el-descriptions-item>
            <el-descriptions-item :label="$t('deviceManage.protocolAddress159')" v-if="operationInformation.otherInformationObj.protocolAddress159">
      ...
      <template v-else-if="activeIndex === '8'">
        ...
        <el-card  style="margin-top: 10px;" v-if="systemSet.otherSet">
          <el-descriptions :title="$t('deviceManage.otherSettings')" :column="3" border>
            ...
            <el-descriptions-item :label="$t('deviceManage.protocolAddress341')" v-if="systemSet.otherSetObj.protocolAddress341">
              <div style="display: flex;">
                <el-input v-model="systemSet.otherSetObj.protocolAddress341Val" :placeholder="$t('common.inputPrompt')">
                  <template slot="append">V</template>
                </el-input>
                <el-button type="text" style="margin-left: 5px;" @click="handleSave('protocolAddress341', systemSet.otherSetObj.protocolAddress341Val)">{{$t('common.save')}}</el-button>
              </div>
            </el-descriptions-item>
            <el-descriptions-item :label="$t('deviceManage.protocolAddress314')" v-if="systemSet.otherSetObj.protocolAddress314">
              <div style="display: flex;">
                <el-input v-model="systemSet.otherSetObj.protocolAddress314Val" :placeholder="$t('common.inputPrompt')">
                  <template slot="append">V</template>
                </el-input>
                <el-button type="text" style="margin-left: 5px;" @click="handleSave('protocolAddress314', systemSet.otherSetObj.protocolAddress314Val)">{{$t('common.save')}}</el-button>
              </div>
            </el-descriptions-item>
            <el-descriptions-item :label="$t('deviceManage.protocolAddress328')" v-if="systemSet.otherSetObj.protocolAddress328">
              <div style="display: flex;">
                <el-input v-model="systemSet.otherSetObj.protocolAddress328Val" :placeholder="$t('common.inputPrompt')">
                  <template slot="append">V</template>
                </el-input>
                <el-button type="text" style="margin-left: 5px;" @click="handleSave('protocolAddress328', systemSet.otherSetObj.protocolAddress328Val)">{{$t('common.save')}}</el-button>
              </div>
            </el-descriptions-item>
            <el-descriptions-item :label="$t('deviceManage.protocolAddress329')" v-if="systemSet.otherSetObj.protocolAddress329">
              <div style="display: flex;">
                <el-input v-model="systemSet.otherSetObj.protocolAddress329Val" :placeholder="$t('common.inputPrompt')">
                  <template slot="append">V</template>
                </el-input>
                <el-button type="text" style="margin-left: 5px;" @click="handleSave('protocolAddress329', systemSet.otherSetObj.protocolAddress329Val)">{{$t('common.save')}}</el-button>
              </div>
            </el-descriptions-item>
            <el-descriptions-item :label="$t('deviceManage.protocolAddress340')" v-if="systemSet.otherSetObj.protocolAddress340">
              <div style="display: flex;">
                <el-input v-model="systemSet.otherSetObj.protocolAddress340Val" :placeholder="$t('common.inputPrompt')">
                  <template slot="append">V</template>
                </el-input>
                <el-button type="text" style="margin-left: 5px;" @click="handleSave('protocolAddress340', systemSet.otherSetObj.protocolAddress340Val)">{{$t('common.save')}}</el-button>
              </div>
            </el-descriptions-item>
    ...
    return {
      ...
      systemSet: {
        ...
        otherSetObj: {
          ...
          // protocolAddress341Val:'',
          // protocolAddress314Val:'',
          // protocolAddress328Val:'',
          // protocolAddress329Val:'',
          // protocolAddress340Val:'',
        },
      },
      batteryParameter: {
        isShow: false,
