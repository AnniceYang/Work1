  ...
  >
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" label-width="110px">
      ...
      <el-form-item :label="$t('deviceManage.snCode')" prop="sn">
        <el-input v-model="dataForm.sn" :placeholder="$t('common.inputPrompt')" />
      </el-form-item>
      ...
      <el-form-item :label="$t('deviceManage.timeZone')" prop="timeZone">
        <el-select v-model="dataForm.timeZone" filterable :placeholder="$t('common.selectPrompt')" style="width: 100%;">
          ...
          <el-option :label="$t('deviceManage.eastSecondDistrict')" :value="2" />
          <el-option :label="$t('deviceManage.eastThirdDistrict')" :value="3" />
          <el-option :label="$t('deviceManage.eastFourthDistrict')" :value="4" />
          <el-option :label="$t('deviceManage.eastFifthDistrict')" :value="5" />
          <el-option :label="$t('deviceManage.eastSixthDistrict')" :value="6" />
          <el-option :label="$t('deviceManage.eastSeventhDistrict')" :value="7" />
          <el-option :label="$t('deviceManage.eastEighthDistrict')" :value="8" />
          <el-option :label="$t('deviceManage.eastNinthDistrict')" :value="9" />
          <el-option :label="$t('deviceManage.eastTenthDistrict')" :value="10" />
          <el-option :label="$t('deviceManage.eastEleventhDistrict')" :value="11" />
          <el-option :label="$t('deviceManage.eastTwelfthDistrict')" :value="12" />
          <el-option :label="$t('deviceManage.westFirstDistrict')" :value="-1" />
          <el-option :label="$t('deviceManage.westSecondDistrict')" :value="-2" />
          <el-option :label="$t('deviceManage.westThirdDistrict')" :value="-3" />
          <el-option :label="$t('deviceManage.westFourthDistrict')" :value="-4" />
          <el-option :label="$t('deviceManage.westFifthDistrict')" :value="-5" />
          <el-option :label="$t('deviceManage.westSixthDistrict')" :value="-6" />
          <el-option :label="$t('deviceManage.westSeventhDistrict')" :value="-7" />
          <el-option :label="$t('deviceManage.westEighthDistrict')" :value="-8" />
          <el-option :label="$t('deviceManage.westNinthDistrict')" :value="-9" />
          <el-option :label="$t('deviceManage.westTenthDistrict')" :value="-10" />
          <el-option :label="$t('deviceManage.westEleventhDistrict')" :value="-11" />
        </el-select>
      </el-form-item>
    </el-form>
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button :loading="loadingState" type="primary" @click="handleSubmit()">{{$t('common.confirm')}}</el-button>
    </span>
  </el-dialog>
</template>
    ...
    handleSubmit() {
      this.$refs.dataForm.validate((valid) => {
        if (valid) {
          ...
          if (this.dataForm.id) {
            editDevice(this.dataForm).then((res) => {
            ...
            addDevice(this.dataForm).then((res) => {
