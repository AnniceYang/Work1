    ...
    <el-form label-width="120px" :inline="true">
      ...
      <el-form-item>
        <el-button
          ...
          type="primary"
          :disabled="checkVal === 0"
          >{{ $t("deviceManage.selfTest") }}</el-button
        >
      </el-form-item>
    </el-form>
        ...
        <el-card class="box-card">
          ...
          >
            ...
            <el-table-column :label="$t('deviceManage.selfInspectionResults')">
              <template slot-scope="scope">
                <el-tag type="success" v-if="scope.row.checkStatus === 0">{{
                  $t("deviceManage.success")
                }}</el-tag>
            ...
            <el-table-column
              prop="selfCheckActualProtectionThreshold"
              :label="$t('deviceManage.selfCheckActualProtectionThreshold')"
            />
            <el-table-column
              prop="selfCheckActualProtectionTime"
              :label="$t('deviceManage.selfCheckActualProtectionTime')"
            />
            <el-table-column
              prop="selfCheckRealTimeProtectionThreshold"
              :label="$t('deviceManage.selfCheckRealtimeProtectionThreshold')"
            />
            <el-table-column
              align="center"
              :label="$t('deviceManage.selfInspectionTime')"
              width="150"
            >
              <template slot-scope="scope">
...
export default {
  data() {
    return {
      ...
      listData: [],
      total: 0,
      selectedRecords: [], //Store selected records
    };
  },
  methods: {
    init(info) {
    ...
    handleSelectionChange(val) {
      ...
      if (val.length > 8) {
        this.$message.error("You can only select up to 8 records.");
        return;
      }
    ...
    handleSelect(selection, row) {
      //Add the selected row to the selectedRecords array if it's not already in there
      if (!this.selectedRecords.includes(row)) {
        if (this.selectedRecords.length < 8) {
          ...
          if (index !== -1) {
            this.$refs.table.toggleRowSelection(this.listData[index], false);
          }
        }
      }
    },
    ...
    initMqttData(messageInfo) {
      if (messageInfo.msgOperation === 5 && messageInfo.valType === 12) {
        // 只渲染除最后三个外的
        console.log("自检初始化数据", JSON.parse(messageInfo.val));
        const valInfo = JSON.parse(messageInfo.val);
        this.tableData1[0].value =
          valInfo.upperLimitValueOfGridVoltageProtection1;
        this.tableData1[1].value = valInfo.gridVoltageProtectionUpperLimitTime1;
        this.tableData1[2].value =
          valInfo.upperLimitValueOfGridVoltageProtection2;
        this.tableData1[3].value = valInfo.gridVoltageProtectionUpperLimitTime2;
        this.tableData1[4].value =
          valInfo.lowerLimitValueOfGridVoltageProtection1;
        this.tableData1[5].value = valInfo.gridVoltageProtectionLowerLimitTime1;
        this.tableData1[6].value =
          valInfo.lowerLimitValueOfGridVoltageProtection2;
        this.tableData1[7].value = valInfo.gridVoltageProtectionLowerLimitTime2;
        this.tableData1[8].value =
          valInfo.upperLimitValueOfGridFrequencyProtection1;
        this.tableData1[9].value =
          valInfo.gridFrequencyProtectionUpperLimitTime1;
        this.tableData2[0].value =
          valInfo.upperLimitValueOfGridFrequencyProtection2;
        this.tableData2[1].value =
          valInfo.gridFrequencyProtectionUpperLimitTime2;
        this.tableData2[2].value =
          valInfo.lowerLimitValueOfGridFrequencyProtection1;
        this.tableData2[3].value =
          valInfo.gridFrequencyProtectionLowerLimitTime1;
        this.tableData2[4].value =
          valInfo.lowerLimitValueOfGridFrequencyProtection2;
        this.tableData2[5].value =
          valInfo.gridFrequencyProtectionLowerLimitTime2;
      } else if (messageInfo.msgOperation === 15) {
        // 只渲染最后三个  0自检成功   1自检失败
        this.loadingState = false;
        clearTimeout(this.timeOutObj);
        if (messageInfo.valType === 0) {
          ...
          this.tableData2[8].value =
            valInfo.selfCheckRealTimeProtectionThreshold;
        } else if (messageInfo.valType === 1) {
          this.$message.error("自检失败");
        }
      } else if (messageInfo.msgOperation === 14) {
        // 1下发成功   2下发失败
    ...
    initData() {
      this.tableData1 = [
        ...
        {
          type: this.$t("deviceManage.upperLimitValueOfVoltage1"),
          unit: "V",
          value: "",
          range: "208~300",
        },
        {
          type: this.$t("deviceManage.voltageUpperLimitTime1"),
          unit: "ms",
          value: "",
          range: "0~30000",
        },
        {
          type: this.$t("deviceManage.upperLimitValueOfVoltage2"),
          unit: "V",
          value: "",
          range: "208~300",
        },
        {
          type: this.$t("deviceManage.voltageUpperLimitTime2"),
          unit: "ms",
          value: "",
          range: "0~30000",
        },
        {
          type: this.$t("deviceManage.lowerLimitValueOfProtection1"),
          unit: "V",
          value: "",
          range: "0~216",
        },
        {
          type: this.$t("deviceManage.voltageLowerLimitTime1"),
          unit: "ms",
          value: "",
          range: "0~30000",
        },
        {
          type: this.$t("deviceManage.lowerLimitValueOfProtection2"),
          unit: "V",
          value: "",
          range: "0~216",
        },
        {
          type: this.$t("deviceManage.voltageLowerLimitTime2"),
          unit: "ms",
          value: "",
          range: "0~30000",
        },
        {
          type: this.$t("deviceManage.upperLimitValue1"),
          unit: "Hz",
          value: "",
          range: "50~65",
        },
        {
          type: this.$t("deviceManage.upperLimitTime1"),
          unit: "ms",
          value: "",
          range: "0~30000",
        },
      ...
      this.tableData2 = [
        ...
        {
          type: this.$t("deviceManage.upperLimitValue2"),
          unit: "Hz",
          value: "",
          range: "50~65",
        },
        {
          type: this.$t("deviceManage.upperLimitTime2"),
          unit: "ms",
          value: "",
          range: "0~30000",
        },
        {
          type: this.$t("deviceManage.lowerLimitValue1"),
          unit: "Hz",
          value: "",
          range: "45~60",
        },
        {
          type: this.$t("deviceManage.lowerLimitTime1"),
          unit: "ms",
          value: "",
          range: "0~30000",
        },
        {
          type: this.$t("deviceManage.lowerLimitValue2"),
          unit: "Hz",
          value: "",
          range: "45~60",
        },
        {
          type: this.$t("deviceManage.lowerLimitTime2"),
          unit: "ms",
          value: "",
          range: "0~30000",
        },
        {
          type: this.$t("deviceManage.protectionThreshold"),
          unit: "V(/Hz)",
          value: "",
          range: "",
        },
        {
          type: this.$t("deviceManage.protectionTime"),
          unit: "ms",
          value: "",
          range: "",
        },
        {
          type: this.$t("deviceManage.realTimeProtectionThreshold"),
          unit: "V(/Hz)",
          value: "",
          range: "",
        },
