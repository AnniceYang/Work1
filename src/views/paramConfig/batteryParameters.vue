<template>
    <div class="container">
      <template>
        ...
        <el-card>
          <div slot="header">
            <span>{{ $t("parameterConfiguration.batterySet") }}</span>
            <el-switch
              style="margin-left: 10px"
              v-model="info.dataList[2].isShow"
              :active-value="1"
              :inactive-value="0"
              @change="changeFirstInfo(2)"
            />
            <el-button
          ...
          <el-card
            v-for="(item, index) in info.dataList[2].dataList"
            style="margin-top: 10px"
          >
            <div slot="header">
              <span>{{
                $t(
                  "parameterConfiguration." + info.dataList[2].dataList[index].key
                )
              }}</span>
              <el-switch
                style="margin-left: 10px"
                :active-value="1"
                :inactive-value="0"
                v-model="info.dataList[2].dataList[index].isShow"
                @change="changeSecondInfo(2, index)"
              />
            </div>
            <div>
              <div class="line">
              ...
              <div
                class="line"
                v-for="(item2, index2) in info.dataList[2].dataList[index]
                  .dataList"
              >
                <div class="item1">
                  {{
                    $t(
                      "parameterConfiguration." +
                        info.dataList[2].dataList[index].dataList[index2].key
                    )
                  }}
                </div>
                <div class="item">
                  <el-switch
                    ...
                    :inactive-value="0"
                    v-model="
                      info.dataList[2].dataList[index].dataList[index2].isShow
                    "
                  />
                </div>
                <div class="item">
                  <el-switch
                    ...
                    :inactive-value="0"
                    v-model="
                      info.dataList[2].dataList[index].dataList[index2]
                        .installerIsShow
                    "
                  />
                </div>
