<template>
  <div class="app-container calendar-list-container">
    ...
    <BannerForm ref="bannerForm" @back="getData" />
  </div>
</template>
<script>
import { qryBanner, delBanner } from '@/api/common/banner'
...
export default {
  ...
  methods: {
    getData(state) {
      ...
      qryBanner(this.listQuery).then(res => {
    ...
    handleAddorEdit(info) {
      this.$refs.bannerForm.init(info)
    },
     // 每页数
