    ...
    return {
      ...
      dataRule: {
        newsTitle: [
          {
            required: true,
            message: this.$t("messageManage.validateTitle"),
            trigger: "blur",
          },
        ],
        newsContent: [
          {
            required: true,
            message: this.$t("messageManage.validateContent"),
            trigger: "blur",
          },
        ],
        ...
        newsSketch: [
          {
            required: true,
            message: this.$t("messageManage.validateSketch"),
            trigger: "blur",
          },
        ],
      },
  ...
  methods: {
    init(info) {
      ...
      if (info) {
        ...
        this.dataForm.fileId = info.adminComFileInfosVo
          ? info.adminComFileInfosVo.fileId
          : "";
      }
      this.visible = true;
      this.$nextTick(() => {
        ...
        this.$refs.fileUpload.init(
          info && info.adminComFileInfosVo
            ? info.adminComFileInfosVo.filePath
            : ""
        );
      });
    },
