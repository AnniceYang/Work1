  ...
  >
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" label-width="120px">
      ...
      <el-form-item :label="$t('alarmControl.alarmName')" prop="name">
        <el-input v-model="dataForm.name" maxlength="50" :placeholder="$t('common.inputPrompt')" />
      </el-form-item>
      <el-form-item :label="$t('alarmControl.displayOrNot')" prop="show">
      ...
      <el-form-item :label="$t('alarmControl.description')" prop="illustrate">
        <el-input v-model="dataForm.illustrate" type="textarea" :autosize="{ minRows: 2, maxRows: 4}" :placeholder="$t('common.inputPrompt')" />
      </el-form-item>
  ...
  data() {
    return {
      ...
      dataRule: {
        ...
        code: [{ required: true, message: this.$t('alarmControl.validateC'), trigger: "blur" }],
        illustrate: [{ required: true, message: this.$t('alarmControl.validateD'), trigger: "blur" }],
        name: [{ required: true, message: this.$t('alarmControl.validateN'), trigger: "blur" }],
      }
    };
  },
  methods: {
