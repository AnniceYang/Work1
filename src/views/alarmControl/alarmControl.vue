      ...
      <div class="header-search">
        ...
        <div class="rside">
          <el-button
            ...
            plain
            @click="handleForm()"
            v-if="permissions.admin_lsyalarmcontrol_add"
      ...
      <div class="avue-crud">
        <el-table :data="dataList" fit v-loading="listLoading">
          <el-table-column
            align="center"
            prop="sort"
            :label="$t('alarmControl.sort')"
            width="50"
          />
          <el-table-column
            align="center"
            prop="code"
            :label="$t('alarmControl.alarmEncoding')"
          />
          <el-table-column
            align="center"
            prop="name"
            :label="$t('alarmControl.alarmName')"
          />
          <el-table-column
            align="center"
          ...
          <el-table-column
            align="center"
            prop="illustrate"
            :label="$t('alarmControl.description')"
            show-overflow-tooltip
          />
          <el-table-column
            align="center"
            :label="$t('alarmControl.createTime')"
            width="150"
          >
            <template slot-scope="scope">
          ...
          >
            <template slot-scope="scope">
              <el-button
                ...
                v-if="permissions.admin_lsyalarmcontrol_edit"
              ...
              <el-button
                ...
                v-if="permissions.admin_lsyalarmcontrol_del"
...
export default {
  ...
  methods: {
    getData(state) {
      ...
      qryAlarmControl(this.listQuery)
        .then((res) => {
