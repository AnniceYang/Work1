<template>
  <!-- 添加或修改菜单对话框 -->
  <el-dialog
    :title="!form.menuId ? $t('common.add') : $t('common.edit')"
    ...
    return {
      ...
      rules: {
        name: [
          {
            required: true,
            message: this.$t("menuManage.validateName"),
            trigger: "blur",
          },
        ],
        sort: [
          {
            required: true,
            message: this.$t("menuManage.validateSort"),
            trigger: "blur",
          },
        ],
        path: [
          {
            required: true,
            message: this.$t("menuManage.validatePath"),
            trigger: "blur",
          },
        ],
        keepAlive: [{ required: true, message: "", trigger: "blur" }],
        // permission: [
