        ...
        <div class="header-search">
          ...
          <div class="rside">
            <el-button
              ...
              v-if="permissions.admin_lsyfault_add"
          ...
          <el-table :data="dataList" border fit v-loading="listLoading">
            ...
            >
              <template slot-scope="scope">
                <el-tag
                  type="success"
                  v-if="scope.row.installerDisplay === 1"
                  >{{ $t("faultInfo.display") }}</el-tag
                >
                <el-tag
                  type="info"
                  v-else-if="scope.row.installerDisplay === 0"
                  >{{ $t("faultInfo.hide") }}</el-tag
                >
              </template>
            </el-table-column>
            <el-table-column
            ...
            >
              <template slot-scope="scope">
                <el-button
                  ...
                  v-if="permissions.admin_lsyfault_edit"
                ...
                <el-button
                  ...
                  v-if="permissions.admin_lsyfault_del"
